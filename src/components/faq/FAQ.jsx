...
const FAQ = () => {
  ...
  const faqs = [
    ...
    url: "https://greenlakepickleball.com/contact", urlText: "this page", url2: "mailto: peter@sla.com", url3: "mailto: pickle.karate.pickle@gmail.com", secondText: " or Dave at ",
    url2Text: "peter@sla.com", url3Text: "pickle.karate.pickle@gmail.com", thirdText: ", or send a direct message from "},
